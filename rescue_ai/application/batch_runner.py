"""Batch mission runner — use-case orchestration only.

DTOs and port protocols live in ``batch_dtos`` so that infrastructure
adapters can depend on thin contracts without pulling in this module.
"""
