...
```mermaid
flowchart LR
E0["Этап 0\nПодготовка данных\nФиксация теста и сплита по миссиям\nРаспределения bbox\nДоля негативов и мелких объектов"]
B1["Этап 1 — Baseline\nПодготовка модели\nYOLOv8n\nФикс. разрешение\nСтандартный пайплайн"]
M1["Этап 1 — MVP\nПодготовка модели\nYOLOv8n\nMulti-scale обучение\nАугментации\nСравнение с бейзлайном"]
E2["Этап 2\nИнтерпретация и калибровка\nАнализ ошибок\nКалибровка порогов\nПроверка сценариев"]
E3["Этап 3\nПостобработка и бизнес-метрики\nДетекции → алерты\nПравила формирования алертов\nRecall_event, FP/min, TtFC"]
B4["Этап 4 — Baseline\nПростой инференс\nОдна модель\nФикс. пороги\nБез оптимизаций"]
M4["Этап 4 — MVP\nИнференс итерациями\nСбор системных метрик\nROI-каскад (мелкие объекты)"]
E5["Этап 5\nИнтеграция\nПоток кадров с RaspberryPi\nAPI инференса\nUI (алерты/взаим.)\nЛоги миссий"]
E6["Этап 6\nОптимизатор\nВыбор итерации по метрикам\nБаланс Recall_event и FP/min"]
E7["Этап 7\nПодготовка к пилоту\nФиксация конфигов\nМанифест миссии\nШаблон отчёта"]
