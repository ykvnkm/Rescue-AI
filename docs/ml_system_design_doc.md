...
- На наземной станции запускаются `api_gateway`, `detection_service`, `flight_adapter`, UI оператора и вспомогательные фоновые компоненты. Развёртывание системы выполняется через Docker Compose на наземной станции управления.
