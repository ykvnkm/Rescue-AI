...
| ----------------------------- | ------------------------- | ---------------- | --------------------- |
| Кадры                         | ДПСО «ЛизаАлерт»          | DS/ML            | +                     |
| Аннотации bbox в YOLO-формате | ДПСО «ЛизаАлерт»          | DS/ML            | +                     |
...
- **Train** - 80% от размеченной части, то есть от `train+val` (**7588** изображений),
- **Val** - 10% от размеченной части (**948** изображений),
- **Holdout (test)** - 10% от размеченной части (**948** изображений),
...
|                                 | Отсутствие bbox везде оформлено как пустой `.txt` файл                                                                       |
